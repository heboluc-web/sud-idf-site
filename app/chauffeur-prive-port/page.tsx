...
export const metadata: Metadata = {
  title: "Chauffeur privé port | VTC port Paris et Île-de-France",
  description:
    "Chauffeur privé port à Paris et en Île-de-France. VTC pour vos transferts vers et depuis les ports, avec un service premium, ponctuel et confortable.",

  alternates: {
    canonical: "https://www.sudidfexecutivetransport.fr/chauffeur-prive-port",
  },
};

export default function ChauffeurPrivePort() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden border-b border-amber-500/20 px-6 py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-8 text-neutral-400 md:text-lg">
            Un service de chauffeur privé VTC pour vos transferts vers et
            depuis les ports. Voyage, croisière ou déplacement professionnel :
            bénéficiez d’une prise en charge confortable et personnalisée.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-light tracking-[0.16em] text-white md:text-4xl">
              Votre chauffeur pour rejoindre le port
            </h2>

            <p className="mt-8 text-base leading-8 text-neutral-400">
              Pour un départ en croisière, un voyage ou un déplacement
              professionnel, votre chauffeur vous accompagne depuis votre
              domicile, votre hôtel, une gare ou un aéroport jusqu’au port.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              [
                ...
                "Prise en charge à l’adresse de votre choix pour rejoindre votre port de départ dans les meilleures conditions.",
              ],
              [
                "Retour depuis le port",
                "À votre arrivée, votre chauffeur vous récupère au port pour rejoindre votre domicile, hôtel, gare ou aéroport.",
              ],
              [
                "Croisières",
                "Un transport privé confortable pour vos départs et retours de croisière, avec une organisation adaptée à votre voyage.",
              ],
              [
                "Hôtels et ports",
                "Transferts entre votre hôtel et le port, avec un service porte-à-porte simple et confortable.",
              ],
              [
                "Gares et aéroports",
                "Organisation de transferts combinés entre gare, aéroport, hôtel et port selon votre itinéraire.",
              ],
              [
                "Service VIP",
                "Une prestation discrète et personnalisée pour les voyageurs recherchant confort et sérénité.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
        ...
        <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-5 text-3xl font-light tracking-[0.14em] text-white md:text-4xl">
              Un chauffeur privé pour vos départs et arrivées
            </h2>

            <p className="mt-7 text-base leading-8 text-neutral-400">
              Un transfert vers un port demande souvent de coordonner plusieurs
              étapes : domicile, hôtel, gare ou aéroport. Avec un chauffeur
              privé, vous bénéficiez d’un transport porte-à-porte organisé
              autour de votre trajet.
            </p>

            <p className="mt-5 text-base leading-8 text-neutral-400">
              Nous pouvons étudier votre itinéraire afin de vous proposer une
              prestation adaptée à vos horaires et à vos besoins.
            </p>
          </div>

          <div className="rounded-3xl border border-amber-500/20 bg-black p-10">
            <h3 className="text-xl tracking-[0.14em] text-amber-400">
              Votre transfert port
            </h3>
            ...
            <ul className="mt-7 space-y-5 text-sm leading-7 text-neutral-400">
              ...
              <li>✓ Possibilité d’organiser plusieurs étapes</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-amber-500/20 px-6 py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-7 max-w-3xl text-center text-sm leading-7 text-neutral-500">
            Nous étudions les transferts vers les ports selon votre destination,
            votre horaire et votre itinéraire.
          </p>
      ...
      <section className="border-b border-amber-500/20 bg-neutral-950 px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-3xl font-light tracking-[0.16em] text-amber-400 md:text-4xl">
            Chauffeur privé port à Paris et en Île-de-France
          </h2>

          <p className="mx-auto mt-7 max-w-3xl text-center text-sm leading-7 text-neutral-500">
            Nous intervenons à Paris et dans les différents départements
            d’Île-de-France pour vos transferts vers les ports et lieux de
            départ de vos voyages.
          </p>
      ...
      <section className="border-b border-amber-500/20 bg-neutral-950 px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 space-y-4">
            {[
              [
                "Proposez-vous un chauffeur privé pour rejoindre un port ?",
                "Oui. Nous pouvons organiser votre transfert depuis Paris, l’Île-de-France, une gare, un hôtel ou un aéroport vers votre port de départ.",
              ],
              [
                "Pouvez-vous venir me chercher au port à mon arrivée ?",
                "Oui. Nous pouvons organiser une prise en charge au port pour vous conduire vers votre destination.",
              ],
              [
                "Transportez-vous les bagages ?",
                "Oui. Le transport porte-à-porte permet de voyager confortablement avec vos bagages. Le véhicule choisi dépend notamment du nombre de passagers et de bagages.",
              ],
              [
                "Pouvez-vous organiser un transfert hôtel-port ?",
                "Oui. Nous pouvons assurer les transferts entre votre hôtel et le port selon votre programme.",
              ],
              [
                "Comment obtenir un tarif pour un transfert vers un port ?",
                "Le tarif dépend notamment du lieu de départ, du port, du nombre de passagers et de l’horaire. Contactez-nous pour une proposition personnalisée.",
              ],
            ].map(([question, answer]) => (
              <details
                key={question}
      ...
      <section className="px-6 py-28 text-center">
        ...
        <h2 className="mx-auto mt-6 max-w-4xl text-3xl font-light tracking-[0.14em] text-white md:text-5xl">
          Votre chauffeur privé pour votre transfert vers le port
        </h2>

        <p className="mx-auto mt-7 max-w-2xl text-base leading-8 text-neutral-400">
          Préparez votre trajet et bénéficiez d’un service premium adapté à
          votre voyage.
        </p>
