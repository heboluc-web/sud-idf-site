    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden border-b border-amber-500/20 px-6 py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-8 text-neutral-400 md:text-lg">
            Un service de chauffeur VTC pour vos trajets longue distance depuis
            Paris et l’Île-de-France, avec un véhicule premium, un chauffeur
            professionnel et une organisation adaptée à votre déplacement.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              [
                "Déplacements privés",
                "Voyagez confortablement pour vos vacances, visites familiales, événements ou déplacements personnels longue distance.",
              ],
              [
              ...
              [
                "Voyages en famille",
                "Un véhicule premium et confortable pour les déplacements de familles et de petits groupes, selon la capacité du véhicule choisi.",
              ],
              [
                "Service VIP",
        ...
        <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-5 text-3xl font-light tracking-[0.14em] text-white md:text-4xl">
              Un trajet organisé selon vos besoins
            </h2>
            ...
            <p className="mt-5 text-base leading-8 text-neutral-400">
              Pour les trajets spécifiques, le tarif est établi selon les
              caractéristiques de la prestation. Vous pouvez nous transmettre
              votre projet afin de recevoir une proposition personnalisée.
            </p>
          </div>
      ...
      <section className="border-b border-amber-500/20 px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-3xl font-light tracking-[0.16em] text-amber-400 md:text-4xl">
            Départs depuis Paris et l’Île-de-France
          </h2>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                Chauffeur longue distance depuis {place}
              </a>
            ))}
          </div>

          <p className="mx-auto mt-10 max-w-3xl text-center text-sm leading-7 text-neutral-500">
            Nous pouvons également organiser des trajets combinés avec les
            aéroports, les gares et les autres destinations proposées par notre
      ...
      <section className="border-b border-amber-500/20 bg-neutral-950 px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 space-y-4">
            {[
              [
                "Proposez-vous des trajets longue distance depuis Paris ?",
                "Oui. Nous organisons des trajets privés longue distance depuis Paris et l’Île-de-France vers de nombreuses destinations en France, selon votre projet.",
              ],
              [
                "Pouvez-vous venir me chercher à mon domicile ?",
                "Oui. La prise en charge peut être organisée à l’adresse de votre choix selon les conditions de votre réservation.",
              ],
              [
                "Le service convient-il aux déplacements professionnels ?",
                "Oui. Le transport longue distance avec chauffeur est adapté aux rendez-vous, déplacements de dirigeants, visites professionnelles et autres besoins d’entreprise.",
              ],
              [
                "Puis-je partir d’un aéroport ou d’une gare ?",
                "Oui. Un trajet longue distance peut être organisé depuis ou vers les principaux aéroports et gares de Paris et d’Île-de-France.",
              ],
              [
                "Comment obtenir le tarif de mon trajet ?",
                "Pour un trajet longue distance, le tarif dépend notamment de la destination, des horaires, du véhicule et des besoins de la prestation. Un devis personnalisé peut être établi.",
              ],
            ].map(([question, answer]) => (
              <details
                key={question}
      ...
      <section className="px-6 py-28 text-center">
        ...
        <h2 className="mx-auto mt-6 max-w-4xl text-3xl font-light tracking-[0.14em] text-white md:text-5xl">
          Organisez votre transport longue distance
        </h2>

        <p className="mx-auto mt-7 max-w-2xl text-base leading-8 text-neutral-400">
          Indiquez votre départ, votre destination et votre programme pour
          recevoir une proposition adaptée à votre trajet.
        </p>
