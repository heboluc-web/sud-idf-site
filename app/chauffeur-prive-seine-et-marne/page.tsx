...
export const metadata: Metadata = {
  ...
  description:
    "Service de chauffeur privé haut de gamme en Seine-et-Marne et en Île-de-France. Transferts Orly, CDG, déplacements business et transport premium 24h/24.",
  ...
  keywords: [
    ...
    "transfert Orly Seine-et-Marne",
    "transfert CDG Seine-et-Marne",
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Oui, nous assurons les transferts premium vers les aéroports d’Orly et Roissy Charles-de-Gaulle depuis toute la Seine-et-Marne et l’Île-de-France."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous dans toute la Seine-et-Marne ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Nos chauffeurs privés interviennent notamment à Melun, Fontainebleau, Sénart et dans toute la Seine-et-Marne."
                }
              },
              {
                "@type": "Question",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6 text-gray-300 text-lg leading-8">
          ...
          <p>
            ...
            Melun, Fontainebleau, Sénart et dans toute l’Île-de-France.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-950 border border-amber-500/20 rounded-2xl p-6">
              ...
              <p className="text-gray-400 leading-7">
                ...
                d’Orly et Roissy Charles-de-Gaulle depuis toute la
                Seine-et-Marne et l’Île-de-France.
              </p>
            </div>

            <div className="bg-neutral-950 border border-amber-500/20 rounded-2xl p-6">
              <h3 className="text-xl text-white mb-3">
                Intervenez-vous dans toute la Seine-et-Marne ?
              </h3>

              <p className="text-gray-400 leading-7">
                Nos chauffeurs privés interviennent notamment à
                Melun, Fontainebleau, Sénart et dans toute la
                Seine-et-Marne.
              </p>
            </div>
