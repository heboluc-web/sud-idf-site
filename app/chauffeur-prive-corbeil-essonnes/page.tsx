...
export const metadata: Metadata = {
  ...
  description:
    "Service de chauffeur privé haut de gamme à Corbeil-Essonnes et en Île-de-France. Transferts aéroports, déplacements business et transport premium.",
};
  ...
  return (
    <main className="min-h-screen bg-black text-white p-10">
      ...
      <h2 className="text-2xl font-semibold mb-4">
        Transport haut de gamme en Essonne
      </h2>
