...
export const metadata: Metadata = {
  ...
  description:
    "Service de chauffeur privé haut de gamme à Melun et en Île-de-France. Transferts Orly, CDG, déplacements business et transport premium 24h/24.",

  keywords: [
    "chauffeur privé Melun",
    "VTC Melun",
    "transfert Orly Melun",
    "transfert CDG Melun",
    "chauffeur business Melun",
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Oui, nous assurons les transferts premium vers les aéroports d’Orly et Roissy Charles-de-Gaulle depuis Melun et toute la Seine-et-Marne."
                }
              },
              {
                "@type": "Question",
                "name": "Intervenez-vous uniquement à Melun ?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "Nos chauffeurs privés interviennent à Melun, Fontainebleau, Sénart ainsi que dans toute l’Île-de-France."
                }
              },
              {
                "@type": "Question",
          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-950 border border-amber-500/20 rounded-2xl p-6">
              ...
              <p className="text-gray-400 leading-7">
                ...
                d’Orly et Roissy Charles-de-Gaulle depuis Melun et toute
                la Seine-et-Marne.
              </p>
            </div>
            ...
            <div className="bg-neutral-950 border border-amber-500/20 rounded-2xl p-6">
              <h3 className="text-xl text-white mb-3">
                Intervenez-vous uniquement à Melun ?
              </h3>

              <p className="text-gray-400 leading-7">
                Nos chauffeurs privés interviennent à Melun,
                Fontainebleau, Sénart ainsi que dans toute
                l’Île-de-France.
              </p>
            </div>
